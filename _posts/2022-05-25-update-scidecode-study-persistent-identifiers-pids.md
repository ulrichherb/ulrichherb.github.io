...
|![update on the scidecode study on persistent identifiers pids](/assets/images/update on the scidecode study on persistent identifiers pids.png)|
|*Taken from [orcid.org](https://info.orcid.org/orcid-and-the-uk-national-pid-consortium/) published under a [CC Zero licence](http://creativecommons.org/publicdomain/zero/1.0/)*|
